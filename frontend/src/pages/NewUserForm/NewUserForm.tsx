...
const NewUserForm = () => {
    ...
    const handleSignUp = async (event: React.ChangeEvent<HTMLFormElement>) => {
        ...
        if (!data.firstName || !data.lastName || !data.username || !data.email || !data.password || !data.retypePassword) {
                ...
                <Card>
                    <CardContent>
                        ...
                        <form onSubmit={handleSignUp}>
                            <TextField name="firstName" value={data.firstName} onChange={handleChange} fullWidth margin="normal" placeholder="First Name" type="text" />
                            <TextField name="lastName" value={data.lastName} onChange={handleChange} fullWidth margin="normal" placeholder="Last Name" type="text" />
                            <TextField name="username" value={data.username} onChange={handleChange} fullWidth margin="normal" placeholder="username" type="username" />
                            <TextField name="email" value={data.email} onChange={handleChange} fullWidth margin="normal" placeholder="Email" type="email" />
                            <TextField name="password" value={data.password} onChange={handleChange} fullWidth margin="normal" placeholder="Password" type="password" />
                            <TextField name="retypePassword" value={data.retypePassword} onChange={handleChange} fullWidth margin="normal" placeholder="Retype Password" type="password" />
